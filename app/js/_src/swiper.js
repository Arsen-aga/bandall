...
new Swiper(".support__swiper", {
  loop: false,
  slidesPerView: 1,
  spaceBetween: 15,
  navigation: {
    nextEl: ".support__swiper-wrapper .swiper-button-next",
    prevEl: ".support__swiper-wrapper .swiper-button-prev",
  },
  mousewheel: {
    enabled: true,
    eventsTarget: ".support__swiper", // или 'container'
